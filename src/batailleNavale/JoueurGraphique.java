...
public class JoueurGraphique extends JoueurAvecGrille {
    ...
    protected void retourDefense(Coordonnee c, int etat) {
        switch (etat) {
            case TOUCHE:
                JOptionPane.showMessageDialog(grilleTirs, "L'adversaire m'a touché en " + c + "!");
                break;
            case COULE:
                JOptionPane.showMessageDialog(grilleTirs, "L'adversaire a coulé un de mes navires en " + c + "!");
                break;
            case GAMEOVER:
                JOptionPane.showMessageDialog(grilleTirs, "C'est fini, j'ai perdu.");
                break;
            default: break;
        }
    }
